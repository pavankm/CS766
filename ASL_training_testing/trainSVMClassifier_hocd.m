...
function [trainedClassifier,gen_error] = trainSVMClassifier_hocd(trainingData)
...
X = inputTable(:, predictorNames);
Y = inputTable.column_51;


 
responseName='column_51';
...
trainedClassifier = fitcecoc(X,Y,'Learners',t,'ResponseName',responseName,...
    'PredictorNames',predictorNames,'ClassNames',classNames)
CMDl = crossval(trainedClassifier);
gen_error = kfoldLoss(CMDl)
