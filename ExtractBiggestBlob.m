...
% folder = fullfile(matlabroot, '/home/pavan/CS766/data/');
% baseFileName = 'a.jpg';
...
% 	end
% end
% grayImage = rgb2gray(imread('data/a.jpg'));
...
binaryImage=imread('/home/pavan/comp_vis_ds/SPMandEBM/SPMandEBM/mask.png');
