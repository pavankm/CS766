...
save('HOCD_GABOR_features.mat', 'features_complete')
% %%% compute KNN Classifier Model and generalization error for this model %%%
 ...
 %[trainedClassifier, gen_error] = trainSVMClassifier_hocd_plus_gabor([features_complete,Y]);
 %%% compute RF Classifier Model and generalization error for this model %%%
 %[trainedClassifier, gen_error] = trainRFClassifier_hocd_plus_gabor([features_complete,Y]);

save('KNN_hocd_gabor.mat', 'trainedClassifier')
