function varargout = ImCamCaptureApp(varargin)
% IMCAMCAPTUREApp MATLAB code for ImCamCaptureApp.fig
%   imaqhwinfo
%   VidObj= videoinput('winvideo',1, 'RGB24_320x240');
%   imaqhwinfo(VidObj)
%  See also: GUIDE, GUIDATA, GUIHANDLES

% Edit the above text to modify the response to help ImCamCaptureApp
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @ImCamCaptureApp_OpeningFcn, ...
                   'gui_OutputFcn',  @ImCamCaptureApp_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ImCamCaptureApp is made visible.
function ImCamCaptureApp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ImCamCaptureApp (see VARARGIN)
set(handles.PRW,'Visible','off')
% Choose default command line output for ImCamCaptureApp
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes ImCamCaptureApp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = ImCamCaptureApp_OutputFcn(hObject, eventdata, handles) 
...
global CAM
%[F,~,NotGet]=imputfile;
F='/Users/ancyphilip/Desktop/cvproject/cvproject 2/ASL_training_testing/test_image.png';
